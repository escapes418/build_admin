<template>
  <div class="header-content">
    <el-row>
      <el-col :span="4">
        <div class="logo">
          <span class="logo-title">筑链社运营管理系统</span>
        </div>
      </el-col>
      <el-col :span="12">
          ...
          <li>
            <el-menu class="avatar" mode="horizontal">
              <el-submenu index="company" popper-class="company-down-menu">
                ...
                <div class="header-menu-item" @click="jumpPage(1)"><i class="iconfont icon-me"></i>个人中心</div>
                <div class="header-menu-item" @click="jumpPage(2)"><i class="iconfont icon-setting"></i>系统设置</div>
                <div class="header-menu-item" @click="jumpPage(3)"><i class="iconfont icon-tuichu"></i>退出</div>
              </el-submenu>
            </el-menu>
          </li>
        </ul>
...
export default {
  ...
  methods: {
    ...
    onJumpNoticeDetail(row) {
      this.$router.push({ path: '/notice/detail/' + row.messageId });
    },
    onJumpNoticeList() {
