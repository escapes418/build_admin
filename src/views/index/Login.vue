  ...
  <div class="login-page">
    <div class="content-flex">
      <div class="login-header">
        ...
        <div class="header-title">筑链社运营管理系统</div>
      </div>
      ...
      <div class="login-footer">
        ...
        <!-- <a class="login-link" href="http://www.coalscc.com" target="__blank">绿资源商城</a> -->
        <!-- <a class="login-link" href="https://www.sijibao.com" target="__blank">admin登录</a> -->
      </div>
    </div>
    <div class="footer-flex">&copy; 2019 物易云通（海南）信息技术有限公司 版权所有</div>
  </div>
</template>
    ...
    submitForm() {
      this.$refs.loginForm.validate(async valid => {
        if (valid) {
          ...
          // 查询菜单、权限
          let perData = await permission.getData();
          // 数据存到store
          await permission.setData(this.$store, perData.menu, perData.list);
          // 清空标签页
          this.clearTabView();
