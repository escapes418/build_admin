    ...
    <div class="menumng-page">
      ...
      <div class="toolbar-panel">
        <div class="toolbar-item">
          <el-button type="primary" @click="onAddMenu" v-has="'setting:sys:menu:add'">添加菜单</el-button>
        </div>
      </div>
          ...
          <span class="custom-tree-node" slot-scope="{ node, data }">
            ...
            <span class="custom-node-content">
              <el-row>
                ...
                <el-col :span="6">
                  <span>
                    <el-button type="text" size="mini" v-has="'setting:sys:menu:edit'" @click="onEditMenu(data)">
                      修改
                    </el-button>
                    <el-button type="text" size="mini" v-has="'setting:sys:menu:del'" @click.stop="onDelMenu(data)">
                      删除
                    </el-button>
                    <el-button type="text" size="mini" v-has="'setting:sys:menu:add'" @click="onAddSubMenu(data)">
                      添加下级菜单
                    </el-button>
                  </span>
                </el-col>
