<template>
  <layout navActive="setting">
    <div class="role-edit-page">
      ...
      <el-form ref="roleForm" :model="roleForm" label-width="80px" :rules="rules" class="role-form-panel">
        ...
        <div class="ml-15">
          <el-button v-if="state != 'view'" type="primary" size="small" @click="onSubmitForm">保存</el-button>
    ...
    onSubmitForm() {
      this.$refs.roleForm.validate(async valid => {
        if (valid) {
          ...
          // 选中的所有节点  和半选节点
          this.roleForm.menuIdList = [...treeRefs.getCheckedKeys(), ...treeRefs.getHalfCheckedKeys()];
