<template>
  <layout navActive="setting">
    <div class="layout-content-list">
      ...
      <el-button type="primary" class="mr-10 mb-10" size="small" v-has="'setting:sys:role:add'" @click="onAddRole"
        >添加角色</el-button
      >
      <el-table :data="tableData.list" border>
        <el-table-column label="角色名称" prop="name" min-width="210" show-overflow-tooltip></el-table-column>
        <el-table-column label="英文名称" prop="enname" min-width="160" show-overflow-tooltip></el-table-column>
